    ...
    return(
        <>
            <div className=" select-none bg-slate-200 duration-200 w-[300px] min-h-[350] rounded-lg p-3 flex flex-col gap-y-3">
                ...
                <p className='bg-slate-50 w-[80%] h-6 font-light text-md'></p>
                <p className='bg-slate-50 w-[70%] h-6 font-light text-md'></p>
                <p className='bg-slate-50 w-[60%] h-6 font-light text-md'></p>
            </div>
        </>
    )
}
